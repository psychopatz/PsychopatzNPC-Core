...
function ISPNCCharacterWindow:setNPC(npcId)
    ...
    summary = self.snapshot and self.snapshot.characterWindow or nil
...
function ISPNCCharacterWindow:render()
    ...
    if active == "Skills" then
        Tabs.RenderSkills(self, self.snapshot or {}, topY)
    elseif active == "Health" then
        Tabs.RenderHealth(self, self.snapshot or {}, topY)
    elseif active == "Protection" then
        Tabs.RenderProtection(self, self.snapshot or {}, topY)
    elseif active == "Temperature" then
        Tabs.RenderTemperature(self, self.snapshot or {}, topY)
    else
        Tabs.RenderInfo(self, self.snapshot or {}, topY)
    end
end
